            ...
            <div className="layout-container py-12 relative z-10 pt-16">
                ...
                <div className={`flex flex-col md:flex-row justify-between items-start gap-12 ${isRTL ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className="flex flex-col md:flex-row gap-16 text-right" dir={isRTL ? "rtl" : "ltr"}>
                        ...
                        <div className="flex flex-col gap-4">
                            <h4 className="text-white font-bold text-lg mb-2">روابط تهمك</h4>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">من هو aitoolsbot</a>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">للتواصل مع فريق aitoolsbot</a>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">الدعم الفني</a>
                        </div>
                ...
                <div className={`mt-16 pt-6 border-t border-[#1a1a24] flex flex-col md:flex-row items-center justify-between gap-6 ${isRTL ? 'md:flex-row-reverse' : ''}`} dir={isRTL ? "rtl" : "ltr"}>
                    ...
                    <p className="text-gray-500 text-sm font-medium">
                        جميع الحقوق محفوظة لـ aitoolsbot
                    </p>

                    <div className="flex items-center gap-6">
                        <a href="#" className="text-gray-500 hover:text-white transition-colors flex items-center gap-2 text-sm">
